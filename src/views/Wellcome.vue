      ...
      <div class="mt-5 animate__animated animate__zoomInUp">
       ...
       <!-- CTA -->
        <button 
          ...
          class="w-10/12 md:w-8/12 text-sm md-text-lg mt-12 font-medium z-100 border border-blue-500 text-gray-100 bg-blue-500 bg-dark p-2 rounded-full pointer active:scale-90 hover:bg-emerald-500 hover:border-emerald-500 hover:text-gray-100 duration-300">
