...
<template>
  <section class="w-full bg-gradient-to-b from-emerald-700 to-emerald-600">
    <section class="container-section pb-12">
      ...
      <Card>
        <template v-slot:body>
          <div class="bg-emerald-900 px-6 py-8 text-center text-sm font-medium" v-for="(timeline, index) in timelines" :key="index">
